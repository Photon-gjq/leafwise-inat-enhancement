...
for (const target of targets) {
  ...
  run(['--test', 'tests/higher-taxa.test.cjs', 'tests/taxon-status.test.cjs', 'tests/uploader-ai.test.cjs', 'tests/vision-score.test.cjs', 'tests/observation-ai.test.cjs', 'tests/build.test.cjs', 'tests/explore-tools.test.cjs'], { LEAFWISE_TARGET: target });
}
