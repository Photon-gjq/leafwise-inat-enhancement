...
提供未觀察高階分類對比、多地點聯集、個人觀察計數、常用使用者／類群，以及上傳頁的批次 AI 建議助手。不是 iNaturalist 官方產品。
...
- **未觀察高階分類**：比較某地有記錄、但指定使用者在全球完全沒觀察過的目／科／屬等類群，顯示當地後代觀察數與可核驗的 Leaf taxa 數。全部生物 ID 為 `48460`，鳥類為 `3`。
- **多地點**：例如 `6903,7613,7887,10301` 為中國、香港、臺灣、澳門的聯集；`any` 表示全球。
- **常用條件及個人計數**：沿用原有的使用者、分類單元與中文名管理功能。
